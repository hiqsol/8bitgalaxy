class Human {
  ...
  static cards() {
    return {
      ...
      'Human-Base-4c':      'a3a,p3c:trade,r2c,r1a',
      'Human-Base-4p':      'a3s,p3p: +fac,r2p,r1s',
      'Human-Base-4s':      'a3c,p3s:hyper,r2s,r1c',

      'Human-Base-5a':      'a6c,p4a: nuke',
      'Human-Base-5c':      'a6p,p4c:colab',
      'Human-Base-5p':      'a6s,p4p:sYard',
      'Human-Base-5s':      'a6a,p4s:espio',

      'Human-Base-6a':      'a5s,p4a:  red,r4a,r3s',
      'Human-Base-6c':      'a5a,p4c:green,r4c,r3a',
      'Human-Base-6p':      'a5c,p4p:yelow,r4p,r3c',
      'Human-Base-6s':      'a5p,p4s: blue,r4s,r3p',
